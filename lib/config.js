...
export const KEYWORDS = {
  HARD: [
    'downgrade', 'outlook negatif', 'krisis', 'anjlok', 'melonjak',
    'asing keluar', 'capital outflow', 'intervensi', 'default',
    'gagal bayar', 'suspensi', 'investigasi', 'fraud', 'likuidasi',
  ...
  EXTREME: [
    'downgrade', 'krisis sistemik', 'intervensi BI', 'capital control',
    'default', 'gagal bayar', 'suspensi perdagangan', 'investigasi OJK'
  ]
};
...
export const TTL = {
  NEWS_DISPATCHED: 2592000,  // 30 hari
  NEWS_DELIVERED: 2592000,   // 30 hari
