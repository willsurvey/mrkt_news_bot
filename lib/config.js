...
// ==================== QUIET HOURS (WIB) ====================
// Dikirim selama jam 06:00 - 22:00 WIB
export const QUIET_HOURS = {
  START: 22,  // 22:00 WIB mulai quiet
  END: 6      // 06:00 WIB selesai quiet
};

// ==================== TTL STORAGE (dalam detik) ====================
export const TTL = {
  NEWS_DISPATCHED: 604800,   // 7 hari
  NEWS_DELIVERED: 604800,    // 7 hari
