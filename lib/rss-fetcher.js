...
export function normalizeArticle(article) {
  ...
  // FIX: RSS sources sudah WIB, tidak perlu convert timezone
  ...
  return {
    ...article,
    pubDate_utc7: pubDate.toISOString(),  // Langsung pakai, tidak perlu convert
    pubDate_hour: pubDate.toISOString().slice(0, 13),
