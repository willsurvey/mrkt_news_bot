...
// FIX: Don't create singleton client at module level
// Create client per invocation for serverless compatibility
...
async function getRedisClient() {
  ...
  try {
    ...
    redisClient = createClient({
      url: redisUrl,
      socket: {
        reconnectStrategy: 0, // Disable auto-reconnect for serverless
        connectTimeout: 5000
      }
    });
