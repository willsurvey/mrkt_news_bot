...
// Bot instance untuk broadcast (tanpa webhook, hanya sendMessage)
...
export async function broadcastToAll(articles, executionId) {
  ...
  for (const article of articles) {
    // Skip saat quiet hours kecuali berita sangat mendesak
    ...
    for (const recipient of recipients) {
      ...
      // Cek apakah berita sudah dikirim ke subscriber ini
      ...
      // Rate limiting: delay antar pesan (Telegram limit: 30 msg/s)
      await sleep(100);
    }
  }
